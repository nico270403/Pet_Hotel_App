...
//         // break;
//          const date = normalizeChatDate(trimmedInput);
//           if (!date) return askQuestion("⚠️ Nu am înțeles data. Scrie ceva ca: mâine / 2026-06-30");

//           setReservationData(p => ({ ...p, checkIn: date }));
//           setReservationStep('checkOut');
//           askQuestion("**Pasul 7:** Data check-out");
//           break;
//       case 'checkOut':
...
//         // break;
//         const date = normalizeChatDate(trimmedInput);
//         if (!date) return askQuestion("⚠️ Data invalidă. Scrie: mâine / 2026-06-30");

//         if (new Date(date) <= new Date(reservationData.checkIn)) {
//           return askQuestion("⚠️ Check-out trebuie să fie după check-in.");
//         }

//         setReservationData(p => ({ ...p, checkOut: date }));
//         setReservationStep('specialRequests');
//         askQuestion("**Pasul 8:** Cerințe speciale? (sau 'fara')");
//         break;
